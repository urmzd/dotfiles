...
Verify standard community health files exist (see `check-project` for full list):

| File | Check |
|------|-------|
| `SECURITY.md` | Exists with vulnerability reporting instructions |
| `CODE_OF_CONDUCT.md` | Exists for public repos |
| `CONTRIBUTING.md` | Matches current build/test commands |
| `CHANGELOG.md` | Exists after first release (auto-generated by sr) |
